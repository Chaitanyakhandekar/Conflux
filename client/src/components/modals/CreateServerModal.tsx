      ...
      <div className="p-6 relative">
        ...
        onClick={()=>{
          handleCreateServer({
            icon:<></>,
            label:"Custom Server",
            desc:"Create sustom server",
            type:"CUSTOM"
          })
        }}
        className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-[8px] bg-[#8B7DFF] text-white text-sm font-semibold hover:bg-[#7C6BFF] shadow-[0_0_16px_rgba(139,125,255,0.2)] transition-all duration-200">
          <Plus size={18} />
